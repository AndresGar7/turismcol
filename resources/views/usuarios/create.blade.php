                ...
                <form action="{{ route('usuarios.store') }}" method="POST">
                    ...
                    <div class="card card-success shadow-lg">
                        <div class="card-header">
                            <h2 class="card-title fw-bold fs-3 mt-1">Nuevo Usuario</h2>
                        </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">    
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" id="email" placeholder="Email">
                                    </div>
                                    @error('email')
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">    
                                        ...
                                        <input class="form-control @error('usuario') is-invalid @enderror" type="text" name="usuario" id="usuario" placeholder="Usuario" disabled>
                                    </div>
                                    @error('usuario')
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control  @error('nombre') is-invalid @enderror" type="text" name="nombre" id="nombre" value="{{ old('nombre') }}" placeholder="Nombres">
                                    </div>
                                    @error('nombre')
                                ...
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control  @error('apellidos') is-invalid @enderror" type="text" name="apellidos" id="apellidos" value="{{ old('apellidos') }}" placeholder="Apellidos">
                                    </div>
                                    @error('apellidos')
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control  @error('telefono') is-invalid @enderror" type="number" name="telefono" id="telefono" value="{{ old('telefono') }}" placeholder="Teléfono">
                                    </div>
                                    @error('telefono')
